...
class Ajax_pagination{
    ...
    var $anchor_class    = '';
    var $show_count      = true;
    var $link_func       = 'getPagination';
    var $loading         = '.img-loader';
    ...
    function create_links(){
        ...
        function getPagination(page){  
            ...
            var order=$('li.sort_item.active').val();
            ...
            var filterparams={ page: page, order_data:order, cat:cat, subcat:subcat };
            ...
            $("<?php echo $this->loading?>").removeClass('hidden');
            /*for filter params*/
            $.ajax({
                type: "POST",
                ...
                success: function(data){
                    $("<?php echo $this->loading?>").addClass('hidden');
