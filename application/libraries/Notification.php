...
public function send_email_direct($from,$to,$cc,$bcc,$subject,$body, $message, $attachments = array()) { 

     	// echo"<pre>";
     	// print_r($attachments);print_r($message);echo"<pre>";print_r($subject); print_r($to); exit;
