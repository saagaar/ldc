...
<h3 class="m-0">Welcome</h3>
  <p>Please enter your email ID and password</p>
      <form  method="post" class="mt-20">
            <div>
                 <input type="text" class="form-control mb-15 no-radius" autocomplete="off" placeholder="Email ID" name="username">
            ...
            <div class="row">
              ...
              <div class="col-xs-6 text-right">
                ...
                <a type="submit" href="<?php echo site_url('user/login/forget/staff')?>" class="fs-8 pull-right mt-10">Forgot Password ?</a>
              </div>
            </div>      
      </form>
