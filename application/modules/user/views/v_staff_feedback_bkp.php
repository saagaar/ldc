...
<div class="container help-desk"><h4 class="mb-15"><b>Help & Feedback Form</b></h4>
	<p>If you don’t make any changes here, fedback will be sent to the author of the page and the option will be name of this page.</p>
	<form class="mt-30" id="feedbackform" enctype="multipart/form-data" method="post" action="" class="form-horizontal">
      <?php   if($this->session->flashdata('success_message'))
			...
			<div class="text-right"><button type="reset" class="btn btn-default fw-6 mr-10">Cancel</button> <button type="submit"  id="feedbackbtn" class="btn btn-pink">Send</button></div>
			</div>
	</form>
</div>
</section>
