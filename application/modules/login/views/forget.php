        ...
        <ul>
          ...
          <li>
            ...
            <div class="cap_sec">
            	...
            	<span id="admin_captcha_container" class="load_new_captcha"><?php echo $admin_captcha; ?></span>

                <img id="new_captcha_button" class="load_new_captcha" src="<?php echo base_url().ADMIN_IMG_DIR; ?>reload_orange.gif" alt="Reload Verification code">
