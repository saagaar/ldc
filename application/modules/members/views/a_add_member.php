            ...
            <ul class="frm">
              ...
              <li>
                <div>
                  ...
                  <input type="text" name="mobile" class="inputtext" size=45 value="<?php echo set_value('mobile');?>">
                  <?=form_error('mobile')?>
                </div>
              </li>
              <li>
                <div>
                  <label>User type:</label>                    
                    ...
                    <input name="user_type" type="radio" value="4" <?php if($this->input->post('user_type') && $this->input->post('user_type') == '4'){ echo 'checked="checked"';}?> />Supplier
                </div>
              </li>
              <li>
                <div>
                  <label>About user <span>*</span> :</label>
                  <textarea name="about_user" class="inputtext"><?php echo set_value('about_user');?></textarea>
            ...
            <ul class="frm">
              <li>
                <div>
                  ...
                  <input name="address" type="text" class="inputtext" id="address" value="<?php echo set_value('address');?>" size=45>
                  <?=form_error('address')?>
                </div>
              </li>
              <li>
                <div>
                  ...
                  <input name="address2" type="text" class="inputtext" id="address2" value="<?php echo set_value('address2');?>" size=45>
                  <?=form_error('address2')?>
                </div>
              </li>
              <li>
                <div>
                  ...
                  <input name="city" type="text" class="inputtext" id="city" value="<?php echo set_value('city');?>" size=45>
                  <?=form_error('city')?>
                </div>
              </li>
              <li>
                <div>
                  ...
                  <input name="state" type="text" class="inputtext" id="state" value="<?php echo set_value('state');?>" size=45>
                  <?=form_error('state')?>
                </div>
              </li>              
              <li>
              ...
              <li>
                <div>
                  ...
                  <input name="post_code" type="text" class="inputtext" id="post_code" value="<?php echo set_value('post_code');?>" size=45>
