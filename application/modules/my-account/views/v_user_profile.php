          ...
          <ul class="user_info">
            ...
            <li>
              <?php 
                            ...
                            $percentage=0;
                            ?>
              <div class="star-ratings-sprite"> <span style="width:<?php echo $percentage;?>%" class="star-ratings-sprite-rating"></span> </div>
            </li>
      ...
      <li>
        <div class="row">
          <div class="col-md-9">
            ...
            <p>
            <div class="star-ratings-sprite-small"> <span style="width:<?php echo $percentageproductrate;?>%" class="star-ratings-sprite-rating-small"></span> </div>
            <?php
            ...
            <div class="star-ratings-sprite-small"> <span style="width:<?php echo $percentreviewuserrate;?>%" class="star-ratings-sprite-rating-small"></span> </div>
          </div>
          <div class="col-md-3">
            <time>
              <?php 
