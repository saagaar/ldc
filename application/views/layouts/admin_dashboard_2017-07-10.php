    ...
    <div class="row">
      <div class="col-sm-5 col-md-3 p-0">
        <ul class="profile-link text-uppercase fw-6">
          ...
          <li class="<?php if($sub_menu_active=='report_management') echo 'active'?>"><a href="<?php echo site_url('/'.ADMIN.'/report_management')?>"><i class="fa fa-file-text-o"></i> REPORT MANAGEMENT</a></li>
          <li <?php if($sub_menu_active=='staff_management') echo 'active'?>><a href="<?php echo site_url('/'.ADMIN.'/staff_management')?>"><i class="fa fa-file-text-o"></i> STAFF MANAGEMENT</a></li>
