    ...
    <div class="row">
      <div class="col-sm-3 col-md-3 p-0">
        <ul class="profile-link text-uppercase fw-6 collapse navbar-collapse" id="m-menu">
          ...
          <li class="<?php if($sub_menu_active=='student_management') echo 'active'?>">
            <a href="<?php echo site_url('/'.STAFF.'student_management');?>"><i class="fa fa-users"></i> STUDENT MANAGMENT</a>
          </li>
