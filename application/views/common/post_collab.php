            ...
            <div class="modal-body">
                <div class="bg_fff text-center">
                    ...
                    <input type="hidden" name="collabsocialmedia" id="collabsocialmedia">
                          ...
                          <?php }
                            if(in_array(VINEMEDIAID,$media)){ ?>
                                      <div class="f_left smediacollab"><a  data-mediaid="<?php echo VINEMEDIAID?>" href="#" class="btn btn-block mediabrand btn-success"><i class="fa fa-vine "></i></a></div>
                          <?php }
                    ...
                    <p>To collaborate on the following platforms, click below to connect them to FameBit!</p>
                        <a href="" class="btn btn-success"><i class="fa fa-vine"></i></a>
                        <a href="" class="btn btn-info btn-intg"><i class="fa fa-instagram"></i></a>
                        <a href="" class="btn btn-info btn-tumb"><i class="fa fa-tumblr"></i></a>
        ...
        <div class="post_collab_container">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group input-group date">
                        <input type="text" class="form-control" id="c_submission_deadline" name="submission_deadline" placeholder="Delivery Date" /><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                    </div>
                    <div class="form-group">
            ...
            <div class="bottom-content" style="text-align:center;">
              <div class="error-message" style="display:none;color:red"></div>
                ...
                <button class="btn btn-success" type="submit" id="create_collab">
                     ...
                     <i class="fa fa-check createcheck"></i> </div>Create Collab
                </button>
            </div>
            </div>
            </form>
