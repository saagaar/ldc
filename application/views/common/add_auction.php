  ...
  <div class="row">
                    ...
                    <div class="form-group" >
                          ...
                          <div id="brwose-image"><h1><i class="fa fa-user"></i></h1></div>
                          
                    <div class="fileUpload btn btn-lg btn-primary"><span>Upload photos</span>
                         <input type="file" name="uploadimage" id="fileUpload" class="upload" accept="image/gif, image/jpeg, image/png" /></div>
