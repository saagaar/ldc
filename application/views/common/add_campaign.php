            ...
            <div class="modal-content text-center">
                ...
                <div class="bg_fff">
                          <div class="row form-group brandtype">
                              ...
                              <div class="col-xs-2 smedia"><a  data-mediaid="<?php// echo VINEMEDIAID?>" href="#" class="btn btn-block mediabrand btn-success"><i class="fa fa-vine "></i></a></div>
                              <div class="col-xs-2 smedia"><a data-mediaid="<?php //echo TUMBLERMEDIAID?>" href="#" class=" mediabrand btn btn-block btn-info btn-tumb"><i class="fa fa-tumblr "></i></a></div>
                ...
                <button type="button" class="btn btn-warning selectbrand"  disabled="disabled" data-toggle="modal" data-target=".bs-example-modal-lg">Go Next <i class="fa fa-arrow-right"></i></button>
              </div>
                    </div>
          </div>
                </div>
                        ...
                        <p>After posting your campaign you'll receive proposals from interested creators. From there simply select the creators you want to work with and let the magic begin.</p>
                            ...
                            <div>      
                                  ...
                                  <div class="error-message" style="display:none;color:red"></div>
                                      ...
                                      <button type="submit" class="btn btn-primary" id="create_campaign" form="addbrandcampaign">
                                     <div class="btn-img" style="float:left">
                                         ...
                                         <i class="fa fa-check createcheck"></i> </div> Create Campaign</button>
                                  </div>
                                  </div>
