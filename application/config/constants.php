...
if($_SERVER['HTTP_HOST'] == "localhost" || $_SERVER['HTTP_HOST'] == "192.168.0.114" )
    define('ROOT_SITE_PATH','http://'.$_SERVER['HTTP_HOST'].'/hightree/');
else if($_SERVER['HTTP_HOST'] == "nepaimpressions.com")
    define('ROOT_SITE_PATH','http://'.$_SERVER['HTTP_HOST'].'/dev/hightree/');
...
define('EXCEL_SAMPLE_PATH',THEMES_DIR.'excel-sample/');
//feedback image directory
define('FILE_PATH',   'upload_files/feedbackimage/');
...
define('ADMIN',						'admin/');
define('ADMIN_DASHBOARD_PATH',		'admin/dashboard');
define('STAFF',						'staff/');
define('STAFF_DASHBOARD_PATH',		'staff/dashboard');
define('STUDENT',						'student/');
define('STUDENT_DASHBOARD_PATH',		'student/dashboard');
define('BIDPACKAGE_PATH',			'upload_files/bidpackage/');
define('IDENTIFICATION_ATTACHMENT','upload_files/identification_doc/');
define('STUDENT_NEWS_PROMOTION',			'student/news_promotion/');
define('STAFF_PROFILE',		'staff/profile');
...
define('NEWS_IMAGE_PATH',		'upload_files/news-promotion-images/');
define('PRODUCT_IMAGE_PATH_TEMP',	'upload_files/product-images-temp/');
define('EXCEL_UPLOAD_PATH',		'upload_files/excel-uploads/');
...
define('SESSION','LGINCT');


define('FRONTEND_SMALL_LIST_PAGE', 50);
define('FRONTEND_LARGE_LIST_PAGE', 40);
...
define('STAFF_SALES_TARGET', 1000);
define('FEEDBACK_ADMIN_EMAIL', 'ayesha.stha40@gmail.com' );
define('FEED_BACK_CONTACT_EMAIL', 'ayesha.stha40@gmail.com' );
